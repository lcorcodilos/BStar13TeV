...
#-----------------------------------------------------------------#
# This is an extension of the original rate maker. It can produce #
# tagrates/pass-fail ratios parameterized as a function of tpt,   #
# Mtw, and Mt for the 1D tagrate and Mt vs tpt for the 2D tagrate #
# It should be used in conjuction with the original and not as    #
# a replacement -LC 5/28/17										  #
#-----------------------------------------------------------------#
...
if options.param == "tpt":
	...
	histPassEta2 = "MpassEta2"
	histFailEta2 = "MfailEta2"
...
Outf2   =   open("fitdata/"+param1D+"pol2input"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf4   =   open("fitdata/"+param1D+"pol4input"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf5   =   open("fitdata/"+param1D+"pol4input"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf7   =   open("fitdata/"+param1D+"pol0input"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf8   =   open("fitdata/"+param1D+"pol0input"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf10   =   open("fitdata/"+param1D+"newfitinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf11   =   open("fitdata/"+param1D+"newfitinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf13   =   open("fitdata/"+param1D+"newfiterrorinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf14   =   open("fitdata/"+param1D+"newfiterrorinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf16   =   open("fitdata/"+param1D+"bpinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf17   =   open("fitdata/"+param1D+"bpinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf19   =   open("fitdata/"+param1D+"bperrorinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf20   =   open("fitdata/"+param1D+"bperrorinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf22   =   open("fitdata/"+param1D+"pol3input"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf23   =   open("fitdata/"+param1D+"pol3input"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf25   =   open("fitdata/"+param1D+"expoconinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf26   =   open("fitdata/"+param1D+"expoconinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf28   =   open("fitdata/"+param1D+"expoconerrorinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf29   =   open("fitdata/"+param1D+"expoconerrorinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf31   =   open("fitdata/"+param1D+"expolininput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf32   =   open("fitdata/"+param1D+"expolininput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
Outf34   =   open("fitdata/"+param1D+"expolinerrorinput"+setstr+"eta1_PSET_"+options.cuts+".txt", "w")
Outf35   =   open("fitdata/"+param1D+"expolinerrorinput"+setstr+"eta2_PSET_"+options.cuts+".txt", "w")
...
neta1 = fdata.Get(histPassEta1)
deta1 = fdata.Get(histFailEta1)

neta2 = fdata.Get(histPassEta2)
deta2 = fdata.Get(histFailEta2)

# Ditto for ttbar and single top

ttneta1 = fttbar.Get(histPassEta1)
ttdeta1 = fttbar.Get(histFailEta1)

ttneta2 = fttbar.Get(histPassEta2)
ttdeta2 = fttbar.Get(histFailEta2)

stneta1 = fsingletop.Get(histPassEta1)
stdeta1 = fsingletop.Get(histFailEta1)

stneta2 = fsingletop.Get(histPassEta2) 
stdeta2 = fsingletop.Get(histFailEta2)
...
MtBins = [105.0,  115.5,  126.0,  136.5,  147.0,  157.5,  168.0,  178.5,  189.0,  199.5,  210.0]
MtBins2 = array('d',MtBins)
...
neta1r = neta1.Rebin(len(bins1D)-1,"neta1r",bins1D)
deta1r = deta1.Rebin(len(bins1D)-1,"deta1r",bins1D)

neta2r = neta2.Rebin(len(bins1D)-1,"neta2r",bins1D)
deta2r = deta2.Rebin(len(bins1D)-1,"deta2r",bins1D)

ttneta1r = ttneta1.Rebin(len(bins1D)-1,"ttneta1r",bins1D)
ttdeta1r = ttdeta1.Rebin(len(bins1D)-1,"ttdeta1r",bins1D)

ttneta2r = ttneta2.Rebin(len(bins1D)-1,"ttneta2r",bins1D)
ttdeta2r = ttdeta2.Rebin(len(bins1D)-1,"ttdeta2r",bins1D)

stneta1r = stneta1.Rebin(len(bins1D)-1,"stneta1r",bins1D)
stdeta1r = stdeta1.Rebin(len(bins1D)-1,"stdeta1r",bins1D)

stneta2r = stneta2.Rebin(len(bins1D)-1,"stneta2r",bins1D)
stdeta2r = stdeta2.Rebin(len(bins1D)-1,"stdeta2r",bins1D)
...
outputa = TFile( "plots/"+options.cuts+"/B_tagging_sigcont"+setstr+"_Ext.root", "recreate" )
outputa.cd()
...
#	dseta2 = SigFiles[ifile].Get("histFailEta2")
...
tagrateeta1.Draw()
c4.Print("plots/"+options.cuts+"/WPTAGETA1FIT"+setstr+"_Ext.root","root")
...
print(BIFP)
tagrateeta2.Draw()
c3.Print("plots/"+options.cuts+"/WPTAGETA2FIT"+setstr+"_Ext.root","root")
#sys.exit()
...
output1 = ROOT.TFile( "Tagrate"+setstr+"2D_"+options.cuts+"_Ext.root", "recreate" )
output2 = ROOT.TFile( "plots/"+options.cuts+"/Tagrate"+setstr+"2Ddelta_Ext.root", "recreate" )

output = ROOT.TFile( "plots/"+options.cuts+"/Tagrate"+setstr+"Slices_Ext.root", "recreate" )
...
neta1r = ROOT.TH2F("neta1r",  "Comparison tpt and Mt",   		len(bins2)-1, bins2,  21,  105,  210 )
deta1r = ROOT.TH2F("deta1r",  "Comparison tpt and Mt",   		len(bins2)-1, bins2,  21,  105,  210 )

neta2r = ROOT.TH2F("neta2r",  "Comparison tpt and Mt",   		len(bins2)-1, bins2,  21,  105,  210 )
deta2r  = ROOT.TH2F("deta2r",  "Comparison tpt and Mt",   		len(bins2)-1, bins2,  21,  105,  210 )
...
c1.RedrawAxis()
c1.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta1SB1'+'_Ext.root', 'root')
c1.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta1SB1'+'_Ext.pdf', 'pdf')
c2 = TCanvas('c2SB1', 'Pt fitted tagrate in 0.5 < Eta <1.15', 800, 500)
tagrateeta2.Draw("COLZ")
c2.RedrawAxis()
c2.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta2SB1'+'_Ext.root', 'root')
c2.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta2SB1'+'_Ext.pdf', 'pdf')
...
gPad.RedrawAxis()
c1.RedrawAxis()
c1.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta1SB2dSB1_Ext.root', 'root')
c1.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta1SB2dSB1_Ext.pdf', 'pdf')
...
gPad.RedrawAxis()
c3.RedrawAxis()
c3.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta2SB2dSB1_Ext.root', 'root')
c3.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta2SB2dSB1_Ext.pdf', 'pdf')
...
c1.RedrawAxis()
c1.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta1SBSUBSB1_Ext.root', 'root')
c1.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta1SBSUBSB1_Ext.pdf', 'pdf')
...
c2.RedrawAxis()
c2.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta2SBSUBSB1_Ext.root', 'root')
c2.Print('plots/'+options.cuts+'/Tagrate'+setstr+'Eta2SBSUBSB1_Ext.pdf', 'pdf')
