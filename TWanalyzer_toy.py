...
if jobs != 1:
	f = TFile( "TWanalyzertoy"+options.set+"_Trigger_nominal_none_job"+options.num+"of"+options.jobs+"_PSET_"+options.cuts+".root", "recreate" )
else:
	f = TFile( "TWanalyzertoy"+options.set+"_Trigger_nominal_none_PSET_"+options.cuts+".root", "recreate" )
