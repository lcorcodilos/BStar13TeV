...
if options.set == "data":
	Data = DIST("Data", "TWtreefile_data_W.root", "Tree", "weight")
	DistsWeWantToEstiamte = [Data]

elif options.set == "QCD":
	QCDHT500 = DIST("QCDHT500", "TWtreefile_QCDHT500_weighted_W.root", "Tree", "weight")
	QCDHT700 = DIST("QCDHT700", "TWtreefile_QCDHT700_weighted_W.root", "Tree", "weight")
	QCDHT1000 = DIST("QCDHT1000", "TWtreefile_QCDHT1000_weighted_W.root", "Tree", "weight")
	QCDHT1500 = DIST("QCDHT1500", "TWtreefile_QCDHT1500_weighted_W.root", "Tree", "weight")
	QCDHT2000 = DIST("QCDHT2000", "TWtreefile_QCDHT2000_weighted_W.root", "Tree", "weight")
...
ttbar = DIST("ttbar", "TWtreefile_ttbar_weighted_W.root", "Tree", "weight")
st_s = DIST("st_s", "TWtreefile_singletop_s_weighted_W.root", "Tree", "weight")
st_t = DIST("st_t", "TWtreefile_singletop_t_weighted_W.root", "Tree", "weight")
st_tB = DIST("st_tB", "TWtreefile_singletop_tB_weighted_W.root", "Tree", "weight")
...
var_array = ["wmass", "tau21", 74,30,330, 20, 0, 1] #Assuming that wmass will stop below 330 -LC
...
FILE = TFile("Tagrate_"+options.set+"_W.root", "RECREATE")
FILE.cd()
