...
presel = '(mass_tw>'+options.mtwcuts.split(',')[0]+')&&(mass_tw<'+options.mtwcuts.split(',')[1]+')'
...
if options.set == "QCD":
	...
	truthbins = array('d',[105,140,180,210])
...
if options.selection == 'full':
	...
	Bstar.SetRegions(['mass_top','tau32',21,105,210,20,0,1],'('+presel+')')
	...
	Bstar.SetRegions(['mass_top','sjbtag',21,105,210,20,0,1],'('+presel+')')
	...
	selection 	= '(tau32<0.65)'
	tag 		= "(tau32<0.65)&&"+presel+'&&(mass_top>105)&&(mass_top<210)'
	antitag 	= "!((tau32<0.65))&&"+presel+'&&(mass_top>105)&&(mass_top<210)'
