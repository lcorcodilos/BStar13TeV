...
if options.set == "data":
	...
	QCDHT500 = DIST("QCDHT500", "TWtreefile_QCDHT500_w.root", "Tree", "weight")
	QCDHT700 = DIST("QCDHT700", "TWtreefile_QCDHT700_w.root", "Tree", "weight")
	QCDHT1000 = DIST("QCDHT1000", "TWtreefile_QCDHT1000_w.root", "Tree", "weight")
	QCDHT1500 = DIST("QCDHT1500", "TWtreefile_QCDHT1500_w.root", "Tree", "weight")
	QCDHT2000 = DIST("QCDHT2000", "TWtreefile_QCDHT2000_w.root", "Tree", "weight")
...
st_s = DIST("st_s", "TWtreefile_singletop_s_w.root", "Tree", "weight")
st_t = DIST("st_t", "TWtreefile_singletop_t_w.root", "Tree", "weight")
st_tB = DIST("st_tB", "TWtreefile_singletop_tB_w.root", "Tree", "weight")
...
var_array = ["wmass", "tau21", 10,30,200, 10, 0, 1] #Assuming that wmass will stop below 330 -LC
