...
def LoadConstants():
	 return  {
		...
		'nev_ttbar':{'MG':11339232, 'PH':182123200,'PHscaleup':9933327,'PHscaledown':9942427},
 		'nev_qcd':{'PT300':2482816,'PT470':1998648,'PT600':1385860,'PT800':399968,'PT1000':299967,'PT1400':39874,'PT1800':39975,'PT2400':39990,'PT3200':39988,'HT500':44138665,'HT700':15621634,'HT1000':4980387,'HT1500':3846616,'HT2000':1960245},
...
def Load_Ntuples(string,bx):
	...
	if string == 'ttbarscaleup':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_TT_TuneCUETP8M1_13TeV-powheg-scaleup-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'ttbarscaledown':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_TT_TuneCUETP8M1_13TeV-powheg-scaledown-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")


	if string == 'QCDHT500':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_HT500to700_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
 	if string == 'QCDHT700':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_HT700to1000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
 	if string == 'QCDHT1000':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_HT1000to1500_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
 	if string == 'QCDHT1500':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_HT1500to2000_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDHT2000':
 		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_HT2000toInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")

	if string == 'QCDPT300':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_300to470_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")	
	if string == 'QCDPT470':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_470to600_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT600':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_600to800_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT800':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_800to1000_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT1000':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_1000to1400_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT1400':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_1400to1800_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT1800':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_1800to2400_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT2400':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_2400to3200_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'QCDPT3200':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_QCD_Pt_3200toInf_TuneCUETP8M1_13TeV_pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")

	if string == 'data':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/JetHT/crab_JetHT_Run2016BCD-PromptReco-v2_Aug1_B2GAnaFW_V1p1_80x_Slim_V2/160801_184634/0000/*.root")
	...
	if string == 'signalLH1200':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-1200_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH1400':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-1400_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH1600':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-1600_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH1800':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-1800_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH2000':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-2000_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH2200':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-2200_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH2400':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-2400_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH2600':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-2600_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH2800':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-2800_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'signalLH3000':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_BstarToTW_M-3000_LH_TuneCUETP8M1_13TeV-madgraph-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	...
	if string == 'singletop_tW':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_ST_tW_top_5f_inclusiveDecays_13TeV-powheg-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
	if string == 'singletop_tWB':
		files = glob.glob("/uscms_data/d3/lcorcodi/BStar13TeV/SlimTuples/crab_ST_tW_antitop_5f_inclusiveDecays_13TeV-powheg-pythia8_B2GAnaFW_V1p1_80x_Slim_V2/*/0000/*.root")
