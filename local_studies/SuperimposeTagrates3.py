...
tagrates_main = ROOT.TFile("../plots/TWrate_Maker_QCD_35851pb_PSET_rate_sideband.root")
tagrates_cheat = ROOT.TFile("../plots/TWrate_Maker_QCD_35851pb_PSET_sideband.root")
