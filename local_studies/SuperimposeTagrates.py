...
tagrates_lowWmass = ROOT.TFile("../plots/TWrate_Maker_QCD_"+Lumi+"_PSET_rate_highWmass.root")
tagrates_highWmass = ROOT.TFile("../plots/TWrate_Maker_QCD_"+Lumi+"_PSET_rate_highWmass1.root")
...
for eta in range(0,2):
	...
	c4.RedrawAxis()
	c4.Print('plots/tagrateeta'+str(eta+1)+'QCDfitBP.pdf', 'pdf')
	c4.Print('plots/tagrateeta'+str(eta+1)+'QCDfitBP.png', 'png')
