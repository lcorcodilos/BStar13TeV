...
cp ../limitsetting/theta/analysis_bstar_right_had_1fb/results/*.txt resultsright/had/
cat resultsright/had/*observed*.txt | grep -v "# x; y" >resultsright/had/observed_limits_1fb.txt
cat resultsright/had/*expected*.txt | grep -v "# x; y; band 0 low; band 0 high; band 1 low; band 1 high" >resultsright/had/expected_limits_1fb.txt
cd resultsright/had/
python limit_plot_shape.py -l 1fb --coupling=right --channel=had --inputFileExp=expected_limits_1fb.txt --inputFileObs=observed_limits_1fb.txt --useLog --outputName=comb
cd ../../
