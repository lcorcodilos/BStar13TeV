...
cp ../limitsetting/theta/analysis_bstar_right_had_10fb/results/*.txt resultsright/had/
cat resultsright/had/*observed*.txt | grep -v "# x; y" >resultsright/had/observed_limits_10fb.txt
cat resultsright/had/*expected*.txt | grep -v "# x; y; band 0 low; band 0 high; band 1 low; band 1 high" >resultsright/had/expected_limits_10fb.txt
cd resultsright/had/
python limit_plot_shape.py -l 10fb --coupling=right --channel=had --inputFileExp=expected_limits_10fb.txt --inputFileObs=observed_limits_10fb.txt --useLog --outputName=comb
cd ../../
