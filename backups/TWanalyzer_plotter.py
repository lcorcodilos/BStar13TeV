...
#sigf = [
#ROOT.TFile("rootfiles/TW"+options.var+"weightedsignalright1200_Trigger_nominal_none_PSET_"+options.cuts+".root"),
#ROOT.TFile("rootfiles/TW"+options.var+"weightedsignalright1500_Trigger_nominal_none_PSET_"+options.cuts+".root"),
#ROOT.TFile("rootfiles/TW"+options.var+"weightedsignalright1800_Trigger_nominal_none_PSET_"+options.cuts+".root")
#]
...
Data = ROOT.TFile("rootfiles/TW"+options.var+options.set+"_Trigger_none_none_PSET_"+options.cuts+".root")
#DataMmup = ROOT.TFile("rootfiles/TW"+options.var+options.set+"_Trigger_none_none_modm_up_PSET_default.root")
#DataMmdown = ROOT.TFile("rootfiles/TW"+options.var+options.set+"_Trigger_none_none_modm_down_PSET_default.root")
...
TTmc = ROOT.TFile("rootfiles/TW"+options.var+"weightedttbar_Trigger_nominal_none_PSET_"+options.cuts+".root")


#TTmcScaleUp = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_nominal_ScaleUp_PSET_"+options.cuts+".root")
#TTmcScaleDown = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_nominal_ScaleDown_PSET_"+options.cuts+".root")

#TTmcPtSmearUp = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_nominal_PtSmearUp_PSET_"+options.cuts+".root")
#TTmcPtSmearDown = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_nominal_PtSmearDown_PSET_"+options.cuts+".root")

#TTmcQ2ScaleUp = ROOT.TFile("rootfiles/TW"+options.var+"ttbarscaleup_Trigger_nominal_none_PSET_"+options.cuts+".root")
#TTmcQ2ScaleDown = ROOT.TFile("rootfiles/TW"+options.var+"ttbarscaledown_Trigger_nominal_none_PSET_"+options.cuts+".root")




#TTmcEtaSmearUp = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_nominal_EtaSmearUp_PSET_"+options.cuts+".root")
#TTmcEtaSmearDown = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_nominal_EtaSmearDown_PSET_"+options.cuts+".root")

#TTmcTriggerUp = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_up_none_PSET_"+options.cuts+".root")
#TTmcTriggerDown = ROOT.TFile("rootfiles/TW"+options.var+"ttbar_Trigger_down_none_PSET_"+options.cuts+".root")

output = ROOT.TFile( "TW"+options.var+"_output_PSET_"+options.cuts+".root", "recreate" )
output.cd()
...
#	sfiles.append(ROOT.TFile("rootfiles/TW"+options.var+"weighted"+stops[ifile]+"_Trigger_nominal_none_PSET_"+options.cuts+".root"))
...
#		sigsqdown+=downsig*downsig
	...
	QCDsys=sqrt(QCDfit*QCDfit + QCDfit1*QCDfit1 + QCDfit2*QCDfit2+ QCDfit3*QCDfit3)
