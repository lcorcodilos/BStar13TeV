...
tagrates = ROOT.TFile("plots/TWrate_Maker_"+options.set+"_PSET_"+options.cuts+".root")
ratedata = TFile(rootdir+"TWratefile"+options.set+"_PSET_"+options.cuts+"weighted.root")
ratettbar = TFile(rootdir+"TWratefilettbar_PSET_"+options.cuts+"weighted.root")
...
SigFiles = [
ROOT.TFile(rootdir+"TWratefileweightedsignalright1200_PSET_"+options.cuts+".root"),
ROOT.TFile(rootdir+"TWratefileweightedsignalright1600_PSET_"+options.cuts+".root"),
ROOT.TFile(rootdir+"TWratefileweightedsignalright2000_PSET_"+options.cuts+".root")
]
...
prelim.DrawLatex( 0.15, 0.91, "#scale[1.0]{CMS Preliminary #sqrt{s} = 13 TeV, 5 fb^{-1}   (0.00 < |#eta| < 0.80) }" )
c1.cd(3)
gPad.SetLeftMargin(0.16)
...
prelim.DrawLatex( 0.15, 0.91, "#scale[1.0]{CMS Preliminary #sqrt{s} = 13 TeV, 5 fb^{-1}   (0.80 < |#eta| < 2.40) }" )
c1.cd(5)
#gPad.SetLeftMargin(0.16)
...
prelim.DrawLatex( 0.15, 0.91, "#scale[1.0]{CMS Preliminary #sqrt{s} = 13 TeV, 5 fb^{-1}   (0.80 < |#eta| < 2.4) }" )
c1.cd(6)
#gPad.SetLeftMargin(0.16)
