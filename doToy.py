...
commands1.append('python grid_tagrate_post.py -c rate_toy')
...
commands1.append('python TWrate_Maker.py -s QCD -c rate_toy')
...
commands1.append('python TWrate_Maker.py -s data -c rate_toy')
...
commands1.append('python TWrate_plotter.py -s QCD -c rate_toy')
...
commands1.append('python TWrate_plotter.py -s data -c rate_toy')
...
commands2.append('python grid_analyzer_post.py -c toy')
commands2.append('cd rootfiles/35851pb/')
commands2.append('python MakeVectorLike.py -c toy')
commands2.append('cd ../../')

commands2.append('python PtReweightStudy.py -c toy')
...
commands2.append('python TWanalyzer_plotter.py -s QCD -c toy -v kinematics')
commands2.append('python TWanalyzer_plotter.py -s data -c toy -v kinematics')
commands2.append('python TWanalyzer_plotter.py -s data -c toy -v kinematics -u off')
